...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			alert("修改密码");
			//接受密码
			var newPass=$("#txtNewPass").val();  //document.getEleById("txtNewPass").value;
			//确认密码
			...
			//校验密码
			if($.trim(newPass)==""){
				$.messager.alert('警告','新密码不能为空或者空白字符串','warning');
				return ;
			}
			//校验前后的密码是否一致
			...
			//检验通过，发送ajax请求   //发送的url                                          //发送的参数                                //回调函数
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		...
		<div id="sessionInfoDiv"
			...
			[<strong>${user.username}</strong>]，欢迎你！您使用[<strong>${localHost}</strong>]IP登录！
		</div>
