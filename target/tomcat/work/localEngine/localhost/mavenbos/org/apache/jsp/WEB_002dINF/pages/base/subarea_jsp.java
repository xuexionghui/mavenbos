...
public final class subarea_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/subarea_export.action\";  //定向到 这个地方\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\ttoolbar : toolbar,       /*load方法会执行这条 url */\r\n");
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      ...
      out.write("\t\t/* \r\n");
      out.write("\t\t 分区条件查询步骤\r\n");
      out.write("\t\t   2、datagrid，将查询条件缓存在datagrid中，使用datagrid的load()方法\r\n");
      out.write("\t\t*/\r\n");
      out.write("\t\t//条件查询分区信息\r\n");
      out.write("\t\t$(\"#btn\").click(function(){\r\n");
      out.write("\t\t\t//alert(\"执行查询...\");\r\n");
      out.write("\t\t\t//将条件的form表单转为json格式\r\n");
      out.write("\t\t\tvar formJson=$('#searchForm').serializeJson();   //这里写时候忘记了写 #号\r\n");
      out.write("\t\t\t$('#grid').datagrid('load',formJson);//根据一些条件，从服务器重新拉取数据,展示在datagrid的表格上\r\n");
      out.write("\t\t\t$('#searchWindow').window(\"close\");     //查询完之后，将查询的窗口关闭\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t//鼠标点击，做保存分区信息时间\r\n");
      out.write("\t\t$(\"#save\").click(function(){\r\n");
      out.write("\t\t\t//先进行校验\r\n");
      out.write("\t\t\tif($('#subareaForm').form('validate')){\r\n");
      out.write("\t\t\t\t$('#subareaForm').submit();//通过校验，提交表单\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$.messager.alert('警告','表单存在非法输入的数据','warning');\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t});\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/subarea_save.action\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t<!-- <input id=\"cc\" class=\"easyui-combobox\" name=\"dept\" data-options=\"valueField:'id',textField:'text',url:'get_data.php'\" /> -->\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<!-- 分区条件查询步骤\r\n");
      out.write("\t    1、通过页面的“查询”按键打开这个窗口 ，按需要封装封装model，这里的属性不需要填写校验\r\n");
      out.write("\t -->\r\n");
      out.write("\t<!-- 查询分区 -->\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>省</td>\r\n");
      out.write("\t\t\t\t\t\t<!--查询条件可以为空，不需要校验  -->\r\n");
      out.write("\t\t\t\t\t\t<!-- 封装model，这里封装model里的region属性中的province属性 -->\r\n");
