...
public final class decidedzone_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t    \r\n");
      out.write("\t    //清除原来的选项\r\n");
      out.write("\t    $(\"#noassociationSelect\").html(\"\");    //清除没有关联定区的客户的 数据\r\n");
      out.write("\t    $(\"#associationSelect\").html(\"\");      //清楚已经关联定区的客户的数据\r\n");
      out.write("\t    \r\n");
      out.write("\t    //发送ajax请求  查询没有关联定区的客户                                                                                                                                                                                                                  \r\n");
      out.write("\t    $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/decidedzone_findCustomerNoConnectDecidedzone.action\",function(data){\r\n");
      out.write("\t    \t//遍历添加下拉选\r\n");
      ...
      out.write("\t    });\r\n");
      out.write("\t    \r\n");
      out.write("\t  //发送ajax请求  查询已经关联定区的客户                                                                                                                                                                                                                  /* 传入 当前选中定区的id值 */\r\n");
      out.write("\t    $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/decidedzone_findCustomerConnectDecidedzone.action\",{id : data.id},function(data){\r\n");
      out.write("\t    \t//遍历data添加下拉选\r\n");
      out.write("\t    \t$(data).each(function(){\r\n");
      out.write("\t    \t\tvar option=$(\"<option value='+this.id+'>\"+this.name+\"(\"+this.address+\")</option>\");\r\n");
      ...
      out.write("\t    \t//将未关联定区的客户数据移动到右边已经关联定区的客户那边\r\n");
      ...
      out.write("\t      //选中右边关联的 option里面的所有数据\r\n");
      out.write("\t      $(\"#associationSelect option\").attr('selected','selected');  //选中右边所有的客户数据\r\n");
      out.write("\t\t  \r\n");
      out.write("\t      //为定区隐藏域设置id\r\n");
      out.write("\t      $('#customerDecidedZoneId').val($('#grid').datagrid('getSelected').id);\r\n");
      out.write("\t      $(\"#customerForm\").submit();   //提交表单\r\n");
      out.write("\t    });\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/decidedzone_makeCustomerConnectDecidedzone.action\" method=\"post\">\r\n");
      out.write("\t\t\t\t<table class=\"table-edit\" width=\"80%\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t<tr class=\"title\">\r\n");
