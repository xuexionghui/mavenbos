...
public final class region_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!-- 导入一键上传的js， ocupload的js文件 -->\r\n");
      out.write("<script type=\"text/javascript\" \r\n");
      out.write("src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      ...
      out.write("\t\talert(\"删除...\");\r\n");
      out.write("\t\t//1、先从表格中取出要删除项的id值\r\n");
      out.write("\t\tvar selections=$('#grid').datagrid('getSelections');\r\n");
      out.write("\t\t//2、校验没有id数据，弹窗提示，并且返回到原来的页面\r\n");
      out.write("\t\tif(selections.length==0){\r\n");
      out.write("\t\t\t$.messager.alert('警告','您没有选择要删除的项','warning');\r\n");
      out.write("\t\t\treturn ; //返回到当前的页面\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t//3、检验有无id数据，有，提交表单\r\n");
      ...
      out.write("\t\t\turl : \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/region_pageQuery.action\",  /* 查询表格的数据进行分页展示 */\r\n");
      ...
      out.write("\t\t/*\r\n");
      out.write("\t\t这个是标准的\r\n");
      out.write("\t\t//对批量导入添加一键上传的效果  仿照ajax的写法\r\n");
      out.write("\t\t$('#button-import').upload({\r\n");
      out.write("\t\t  name:'upload',  //上传的文件名字，相当于<input type=\"file\" name=\"upload\"/>\r\n");
      out.write("\t\t  action:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/region_importXls.action',\r\n");
      out.write("\t\t  onComplete:function(response){   //回调的函数\r\n");
      out.write("\t\t\t  //var data=eval(\"(\"+response+\")\");\r\n");
      out.write("\t\t\t  var data = eval(\"(\"+response+\")\");  //将一个数据转成json格式的\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t\t*/\r\n");
      out.write("\t\t//一键上传的使用   ocload\r\n");
      out.write("\t\t$('button-import').upload({\r\n");
      out.write("\t\t\tname:'upload',    \r\n");
      out.write("\t\t\taction:'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/region_importXls.action',\r\n");
      out.write("\t\t\tonComplete:function(response){    //回调函数\r\n");
      out.write("\t\t\t  var data=eval(\"(\"+response+\")\");   //将数据转成json格式\t\r\n");
      out.write("\t\t\t  $.messager.alert('信息',data.msg,'info');\r\n");
      out.write("\t\t\t  $('#grid').reload('reload');\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\r\n");
      out.write("\t\t//保存或者修改区域信息添加点击事件\r\n");
      ...
      out.write("\t     }else{\r\n");
      out.write("\t    \t //弹出提示信息\r\n");
      out.write("\t    \t$.messager.alert('警告','表单存在非法的数据','warning');\r\n");
      out.write("\t     }\r\n");
      out.write("\t    });\r\n");
      out.write("\t});\r\n");
      out.write("    \r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/region_deleteBatch.action\" method=\"post\">\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/region_saveOrUpdate.action\"  method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>省</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input  id=\"province\" type=\"text\" name=\"province\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>市</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input id=\"city\" type=\"text\" name=\"city\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>区</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input  id=\"district\" type=\"text\" name=\"district\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>邮编</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input  id=\"postcode\" type=\"text\" name=\"postcode\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>简码</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input id=\"shortcode\" type=\"text\" name=\"shortcode\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>城市编码</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input id=\"citycode\"  type=\"text\" name=\"citycode\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
